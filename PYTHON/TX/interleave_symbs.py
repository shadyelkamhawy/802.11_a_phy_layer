import numpy as np
from TX.constants import w48, w96, w192, w288
...
def interleave_symbs(bits, NCBPS):
    ...
    if NCBPS == 48:
        bits_inter = [bits[i] for i in a48]
    elif NCBPS == 96:
        bits_inter = [bits[i] for i in a96]
    elif NCBPS == 192:
        bits_inter = [bits[i] for i in a192]
    elif NCBPS == 288:
        bits_inter = [bits[i] for i in a288]
